...
var Auth0Provider = function (opts) {
    ...
    var client = useState(function () { return new Ei(toAuth0ClientOptions(clientOpts)); })[0];
 ...
 */
var withAuth0 = function (Component) { return function (props) { return (React.createElement(Auth0Context.Consumer, null, function (auth) { return (React.createElement(Component, __assign({ auth0: auth }, props))); })); }; };
...
export { Auth0Context, Auth0Provider, ni as InMemoryCache, ti as LocalStorageCache, OAuthError, xi as User, useAuth0, withAuth0, withAuthenticationRequired };
